...
class OnboardingActivity : AppCompatActivity() {
    ...
    private val steps by lazy {
        listOf(
            Step(R.string.onb_step1_title, R.string.onb_step1_sub, R.string.onb_step1_desc,
                R.drawable.ic_onb_sms, Manifest.permission.RECEIVE_SMS, R.string.step_sms),
            Step(R.string.onb_step2_title, R.string.onb_step2_sub, R.string.onb_step2_desc,
                R.drawable.ic_onb_sms, Manifest.permission.SEND_SMS, R.string.step_send),
    ...
    private fun showStep() {
        ...
        b.tvStepLabel.text = getString(R.string.step_of, currentStep + 1, steps.size, getString(step.labelRes))
        val alreadyGranted = step.permission == null ||
    ...
    private fun handleGrantClick() {
        val perm = steps[currentStep].permission
